...
export function useVoiceSession({ demoMode, identity, microphoneDisabled, observedServerId, outputDisabled, userId }: VoiceSessionOptions) {
  ...
  return {
    ...
    screenShares,
    screenAudioMuted: liveRoom.screenAudioMuted,
    screenVolumeByUser: liveRoom.screenVolumeByUser,
    setParticipantVolume: liveRoom.setParticipantVolume,
    setScreenAudioSilenced: liveRoom.setScreenAudioSilenced,
    setScreenAudioVolume: liveRoom.setScreenAudioVolume,
