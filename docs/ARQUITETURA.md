...
A interface usa tokens semanticos e separa familia visual de modo de cor. O tema `darkcord` oferece claro e escuro; o modo padrao `system` acompanha `prefers-color-scheme`. Novas familias, como iOS e neo-brutalismo, entram pelo registro de temas sem alterar a logica dos componentes.
